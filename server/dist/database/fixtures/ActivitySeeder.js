...
class ActivitySeeder extends AbstractSeeder_1.default {
    constructor() {
        super({ table: "activity", truncate: true, dependencies: [UserSeeder_1.default] });
    }
    run() {
...
exports.default = ActivitySeeder;
